...
namespace BHSTG.Product
{
    public class Grunt2 : Entity
    {
        ...
        public Grunt2(Vector2 position, Vector2 end, int gHealth, bool speed, GameSprite sprite, Texture2D newBulletTexture, ContentManager content, MovementStrategy movement, ShootingStrategy shooting) : base(position, gHealth, speed, sprite, content, movement, shooting)
        {
